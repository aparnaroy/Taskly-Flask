...
function toggleNav() {
    ...
    if (sidebarIcon.src.includes('sidebar-icon-black.png')) {
        sidebarIcon.src = '../static/img/sidebar-icon-white.png';
    } else {
        sidebarIcon.src = '../static/img/sidebar-icon-black.png';
    }
...
function addTask() {
    ...
    newTask.innerHTML = `<div class="circle" onclick="taskCompleted(event)"></div>
                        ...
                        <img src="../static/img/tag.png" class="tag-button" onclick="toggleTagDropdown(event)" />
